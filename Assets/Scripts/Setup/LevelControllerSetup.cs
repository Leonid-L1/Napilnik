...
public class LevelControllerSetup : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _enemySpawner.Init(_settings.EnemyTemplate, _settings.EnemiesCount, _settings.TimeBetweenEnemySpawn, _enemyProgression.GetComponent<EnemyProgressionBarView>());
